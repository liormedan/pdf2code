...
/**
 * The long form: everything the one-screen entry page cannot hold.
 *
 * / is a single viewport with the headline, the proof and the invitation. A reader who
 * wants the detail — the film, the use cases, how the two layers work, what is shipped
 * and what is only planned — arrives here.
 *
 ...
 */
export default async function AboutPage({ searchParams }: { searchParams: Promise<{ noted?: string; interest?: string }> }) {
    ...
    <div className="mx-auto max-w-3xl px-6">
      ...
      <main className="space-y-20 pb-24">
        <section className="space-y-3 pt-8">
          <h1 className="text-3xl font-semibold tracking-tight text-balance">{t("aboutTitle")}</h1>
          <p className="max-w-[56ch] text-base leading-relaxed text-muted-foreground">{t("aboutLead")}</p>
        </section>

...
const nextConfig = {
  // Keep production builds out of the dev server's directory. Sharing one .next means
  // running `next build` while `next dev` is live corrupts the dev server's chunk map,
  // and it fails with a baffling "Cannot find module './833.js'".
